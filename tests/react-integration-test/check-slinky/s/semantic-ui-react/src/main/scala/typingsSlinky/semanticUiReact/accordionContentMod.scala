...
object accordionContentMod {
  ...
  @scala.inline
  def default: ReactComponentClass[AccordionContentProps] = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("default")).asInstanceOf[ReactComponentClass[AccordionContentProps]]
}
