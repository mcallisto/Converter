...
import typingsSlinky.semanticUiReact.inputInputMod.default
...
object InputInputMod {
  ...
  implicit def make(companion: InputInputMod.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
