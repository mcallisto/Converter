...
object accordionTitleMod {
  ...
  @scala.inline
  def default: ReactComponentClass[AccordionTitleProps] = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("default")).asInstanceOf[ReactComponentClass[AccordionTitleProps]]
}
