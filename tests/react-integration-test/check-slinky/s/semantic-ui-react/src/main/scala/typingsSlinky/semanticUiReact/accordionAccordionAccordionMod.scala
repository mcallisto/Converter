...
object accordionAccordionAccordionMod {
  ...
  @scala.inline
  def default: ReactComponentClass[AccordionAccordionProps] = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("default")).asInstanceOf[ReactComponentClass[AccordionAccordionProps]]
}
