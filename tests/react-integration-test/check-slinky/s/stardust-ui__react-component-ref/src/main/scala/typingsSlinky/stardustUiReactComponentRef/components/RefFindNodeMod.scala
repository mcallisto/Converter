...
object RefFindNodeMod {
  ...
  implicit def make(companion: RefFindNodeMod.type): SharedBuilder_RefProps1237054395[default] = new SharedBuilder_RefProps1237054395[default](js.Array(this.component, js.Dictionary.empty))()
}
