...
object mod {
  ...
  @scala.inline
  def ContextMenu: ReactComponentClass[ContextMenuProps] = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("ContextMenu")).asInstanceOf[ReactComponentClass[ContextMenuProps]]
  @scala.inline
  def ContextMenuTrigger: ReactComponentClass[ContextMenuTriggerProps] = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("ContextMenuTrigger")).asInstanceOf[ReactComponentClass[ContextMenuTriggerProps]]
  @scala.inline
  def MenuItem: ReactComponentClass[MenuItemProps] = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("MenuItem")).asInstanceOf[ReactComponentClass[MenuItemProps]]
  @scala.inline
  def SubMenu: ReactComponentClass[SubMenuProps] = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("SubMenu")).asInstanceOf[ReactComponentClass[SubMenuProps]]
  @scala.inline
