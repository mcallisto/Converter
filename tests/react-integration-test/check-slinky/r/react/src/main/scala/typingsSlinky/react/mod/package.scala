...
package object mod {
  ...
  @scala.inline
  def Children: typingsSlinky.react.mod.ReactChildren = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("Children")).asInstanceOf[typingsSlinky.react.mod.ReactChildren]
  @scala.inline
  def Fragment: slinky.core.ReactComponentClass[typingsSlinky.react.anon.Children] = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("Fragment")).asInstanceOf[slinky.core.ReactComponentClass[typingsSlinky.react.anon.Children]]
  @scala.inline
  def Profiler: slinky.core.ReactComponentClass[typingsSlinky.react.mod.ProfilerProps] = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("Profiler")).asInstanceOf[slinky.core.ReactComponentClass[typingsSlinky.react.mod.ProfilerProps]]
  @scala.inline
  def StrictMode: slinky.core.ReactComponentClass[typingsSlinky.react.anon.Children] = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("StrictMode")).asInstanceOf[slinky.core.ReactComponentClass[typingsSlinky.react.anon.Children]]
  /**
    * This feature is not yet available for server-side rendering.
    * Suspense support will be added in a later release.
    */
  @scala.inline
  def Suspense: slinky.core.ReactComponentClass[typingsSlinky.react.mod.SuspenseProps] = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("Suspense")).asInstanceOf[slinky.core.ReactComponentClass[typingsSlinky.react.mod.SuspenseProps]]
  // Custom components
  @scala.inline
  def cloneElement[P](
  ...
  ): typingsSlinky.react.mod.FunctionComponentElement[P] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("cloneElement")(element.asInstanceOf[js.Any], props.asInstanceOf[js.Any], children.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.react.mod.FunctionComponentElement[P]]
  @scala.inline
  def cloneElement[P](
    element: typingsSlinky.react.mod.FunctionComponentElement[P],
  ...
  def cloneElement[P](
    ...
    props: typingsSlinky.std.Partial[P] with typingsSlinky.react.mod.Attributes,
    children: slinky.core.facade.ReactElement*
  ): slinky.core.facade.ReactElement = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("cloneElement")(element.asInstanceOf[js.Any], props.asInstanceOf[js.Any], children.asInstanceOf[js.Any])).asInstanceOf[slinky.core.facade.ReactElement]
  @scala.inline
  def cloneElement[P](
    element: typingsSlinky.react.mod.ReactElement,
    props: js.UndefOr[scala.Nothing],
  ...
  def cloneElement[P, T /* <: slinky.core.ReactComponentClass[P] */](
    ...
    children: slinky.core.facade.ReactElement*
  ): typingsSlinky.react.mod.CElement[P, T] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("cloneElement")(element.asInstanceOf[js.Any], props.asInstanceOf[js.Any], children.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.react.mod.CElement[P, T]]
  @scala.inline
  def cloneElement[P, T /* <: slinky.core.ReactComponentClass[P] */](
    element: typingsSlinky.react.mod.CElement[P, T],
    props: js.UndefOr[scala.Nothing],
  ...
  def cloneElement[P /* <: typingsSlinky.react.mod.HTMLAttributes[T] */, T /* <: org.scalajs.dom.raw.HTMLElement */](
    ...
    props: P,
    children: slinky.core.facade.ReactElement*
  ): typingsSlinky.react.mod.ReactHTMLElement[T] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("cloneElement")(element.asInstanceOf[js.Any], props.asInstanceOf[js.Any], children.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.react.mod.ReactHTMLElement[T]]
  @scala.inline
  def cloneElement[P /* <: typingsSlinky.react.mod.HTMLAttributes[T] */, T /* <: org.scalajs.dom.raw.HTMLElement */](
    element: typingsSlinky.react.mod.ReactHTMLElement[T],
    props: js.UndefOr[scala.Nothing],
  ...
  def cloneElement[P /* <: typingsSlinky.react.mod.SVGAttributes[T] */, T /* <: org.scalajs.dom.raw.SVGElement */](
    ...
    props: P,
    children: slinky.core.facade.ReactElement*
  ): typingsSlinky.react.mod.ReactSVGElement = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("cloneElement")(element.asInstanceOf[js.Any], props.asInstanceOf[js.Any], children.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.react.mod.ReactSVGElement]
  @scala.inline
  def cloneElement[P /* <: typingsSlinky.react.mod.SVGAttributes[T] */, T /* <: org.scalajs.dom.raw.SVGElement */](
    element: typingsSlinky.react.mod.ReactSVGElement,
    props: js.UndefOr[scala.Nothing],
  ...
  def cloneElement_P_HTMLAttributesTT_HTMLElement_DetailedReactHTMLElement[P /* <: typingsSlinky.react.mod.HTMLAttributes[T] */, T /* <: org.scalajs.dom.raw.HTMLElement */](
    ...
    props: P,
    children: slinky.core.facade.ReactElement*
  ): typingsSlinky.react.mod.DetailedReactHTMLElement[P, T] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("cloneElement")(element.asInstanceOf[js.Any], props.asInstanceOf[js.Any], children.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.react.mod.DetailedReactHTMLElement[P, T]]
  @scala.inline
  def cloneElement_P_HTMLAttributesTT_HTMLElement_DetailedReactHTMLElement[P /* <: typingsSlinky.react.mod.HTMLAttributes[T] */, T /* <: org.scalajs.dom.raw.HTMLElement */](
    element: typingsSlinky.react.mod.DetailedReactHTMLElement[P, T],
    props: js.UndefOr[scala.Nothing],
  ...
  @scala.inline
  def createContext[T](defaultValue: T): typingsSlinky.react.mod.Context[T] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("createContext")(defaultValue.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.react.mod.Context[T]]
  @scala.inline
  def createContext[T](defaultValue: T, calculateChangedBits: js.Function2[/* prev */ T, /* next */ T, scala.Double]): typingsSlinky.react.mod.Context[T] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("createContext")(defaultValue.asInstanceOf[js.Any], calculateChangedBits.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.react.mod.Context[T]]
  @scala.inline
  def createElement[P /* <: js.Object */](
    `type`: java.lang.String,
    props: typingsSlinky.react.mod.Attributes with P,
    children: slinky.core.facade.ReactElement*
  ): slinky.core.facade.ReactElement = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("createElement")(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any], children.asInstanceOf[js.Any])).asInstanceOf[slinky.core.facade.ReactElement]
  @scala.inline
  def createElement[P /* <: js.Object */](
    `type`: java.lang.String,
    props: js.UndefOr[scala.Nothing],
  ...
  @scala.inline
  def createElement[P /* <: js.Object */](`type`: java.lang.String, props: scala.Null, children: slinky.core.facade.ReactElement*): slinky.core.facade.ReactElement = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("createElement")(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any], children.asInstanceOf[js.Any])).asInstanceOf[slinky.core.facade.ReactElement]
  @scala.inline
  def createElement[P /* <: js.Object */](
    ...
    children: slinky.core.facade.ReactElement*
  ): typingsSlinky.react.mod.CElement[P, slinky.core.ReactComponentClass[P]] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("createElement")(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any], children.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.react.mod.CElement[P, slinky.core.ReactComponentClass[P]]]
  @scala.inline
  def createElement[P /* <: js.Object */](
    `type`: typingsSlinky.react.mod.ClassType[P, slinky.core.ReactComponentClass[P], slinky.core.ReactComponentClass[P]],
    props: js.UndefOr[scala.Nothing],
  ...
  def createElement[P /* <: js.Object */](
    ...
    props: typingsSlinky.react.mod.Attributes with P,
    children: slinky.core.facade.ReactElement*
  ): typingsSlinky.react.mod.FunctionComponentElement[P] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("createElement")(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any], children.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.react.mod.FunctionComponentElement[P]]
  @scala.inline
  def createElement[P /* <: js.Object */](
    `type`: typingsSlinky.react.mod.FunctionComponent[P],
    props: js.UndefOr[scala.Nothing],
  ...
  def createElement[P /* <: typingsSlinky.react.mod.SVGAttributes[T] */, T /* <: org.scalajs.dom.raw.SVGElement */](
    ...
    props: typingsSlinky.react.mod.ClassAttributes[T] with P,
    children: slinky.core.facade.ReactElement*
  ): typingsSlinky.react.mod.ReactSVGElement = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("createElement")(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any], children.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.react.mod.ReactSVGElement]
  @scala.inline
  def createElement[P /* <: typingsSlinky.react.mod.SVGAttributes[T] */, T /* <: org.scalajs.dom.raw.SVGElement */](
    `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 55 */ js.Any,
    props: js.UndefOr[scala.Nothing],
  ...
  def createElement[P /* <: js.Object */, T /* <: slinky.core.ReactComponentClass[P] */, C /* <: slinky.core.ReactComponentClass[P] */](
    ...
    props: typingsSlinky.react.mod.ClassAttributes[T] with P,
    children: slinky.core.facade.ReactElement*
  ): typingsSlinky.react.mod.CElement[P, T] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("createElement")(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any], children.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.react.mod.CElement[P, T]]
  @scala.inline
  def createElement[P /* <: js.Object */, T /* <: slinky.core.ReactComponentClass[P] */, C /* <: slinky.core.ReactComponentClass[P] */](
    `type`: typingsSlinky.react.mod.ClassType[P, T, C],
    props: js.UndefOr[scala.Nothing],
  ...
  @scala.inline
  def createElement_P_DOMAttributesTT_Element_DOMElement[P /* <: typingsSlinky.react.mod.DOMAttributes[T] */, T /* <: org.scalajs.dom.raw.Element */](`type`: java.lang.String, props: scala.Null, children: slinky.core.facade.ReactElement*): slinky.core.facade.ReactElement = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("createElement")(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any], children.asInstanceOf[js.Any])).asInstanceOf[slinky.core.facade.ReactElement]
  @scala.inline
  def createElement_P_HTMLAttributesTT_HTMLElement_DetailedReactHTMLElement[P /* <: typingsSlinky.react.mod.HTMLAttributes[T] */, T /* <: org.scalajs.dom.raw.HTMLElement */](
    ...
    props: typingsSlinky.react.mod.ClassAttributes[T] with P,
    children: slinky.core.facade.ReactElement*
  ): typingsSlinky.react.mod.DetailedReactHTMLElement[P, T] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("createElement")(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any], children.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.react.mod.DetailedReactHTMLElement[P, T]]
  @scala.inline
  def createElement_P_HTMLAttributesTT_HTMLElement_DetailedReactHTMLElement[P /* <: typingsSlinky.react.mod.HTMLAttributes[T] */, T /* <: org.scalajs.dom.raw.HTMLElement */](
    `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 115 */ js.Any,
    props: js.UndefOr[scala.Nothing],
  ...
  ] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("createElement")(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any], children.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.react.mod.DetailedReactHTMLElement[
    typingsSlinky.react.mod.InputHTMLAttributes[org.scalajs.dom.raw.HTMLInputElement], 
    org.scalajs.dom.raw.HTMLInputElement
  ]]
  @scala.inline
  ...
  @scala.inline
  def createFactory(`type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 55 */ js.Any): typingsSlinky.react.mod.SVGFactory = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("createFactory")(`type`.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.react.mod.SVGFactory]
  @scala.inline
  def createFactory[P](
    `type`: typingsSlinky.react.mod.ClassType[P, slinky.core.ReactComponentClass[P], slinky.core.ReactComponentClass[P]]
  ): typingsSlinky.react.mod.CFactory[P, slinky.core.ReactComponentClass[P]] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("createFactory")(`type`.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.react.mod.CFactory[P, slinky.core.ReactComponentClass[P]]]
  @scala.inline
  def createFactory[P](`type`: typingsSlinky.react.mod.ComponentClass[P, js.Object]): typingsSlinky.react.mod.Factory[P] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("createFactory")(`type`.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.react.mod.Factory[P]]
  // Custom components
  @scala.inline
  def createFactory[P](`type`: typingsSlinky.react.mod.FunctionComponent[P]): typingsSlinky.react.mod.FunctionComponentFactory[P] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("createFactory")(`type`.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.react.mod.FunctionComponentFactory[P]]
  @scala.inline
  def createFactory[P /* <: typingsSlinky.react.mod.DOMAttributes[T] */, T /* <: org.scalajs.dom.raw.Element */](`type`: java.lang.String): typingsSlinky.react.mod.DOMFactory[P, T] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("createFactory")(`type`.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.react.mod.DOMFactory[P, T]]
  @scala.inline
  def createFactory[P, T /* <: slinky.core.ReactComponentClass[P] */, C /* <: slinky.core.ReactComponentClass[P] */](`type`: typingsSlinky.react.mod.ClassType[P, T, C]): typingsSlinky.react.mod.CFactory[P, T] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("createFactory")(`type`.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.react.mod.CFactory[P, T]]
  //
  // Top Level API
  // ----------------------------------------------------------------------
  // DOM Elements
  @scala.inline
  def createFactory_T_HTMLElement_HTMLFactory[T /* <: org.scalajs.dom.raw.HTMLElement */](`type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 115 */ js.Any): typingsSlinky.react.mod.HTMLFactory[T] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("createFactory")(`type`.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.react.mod.HTMLFactory[T]]
  @scala.inline
  def createRef[T](): slinky.core.facade.ReactRef[T] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("createRef")()).asInstanceOf[slinky.core.facade.ReactRef[T]]
  @scala.inline
  ...
  ] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("forwardRef")(Component.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.react.mod.ForwardRefExoticComponent[
    typingsSlinky.react.mod.PropsWithoutRef[P] with typingsSlinky.react.mod.RefAttributes[T]
  ]]
  @scala.inline
  ...
  ): slinky.core.ReactComponentClass[T] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("lazy")(factory.asInstanceOf[js.Any])).asInstanceOf[slinky.core.ReactComponentClass[T]]
  @scala.inline
  def memo[T /* <: slinky.core.ReactComponentClass[_] */](Component: T): slinky.core.ReactComponentClass[T] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("memo")(Component.asInstanceOf[js.Any])).asInstanceOf[slinky.core.ReactComponentClass[T]]
  @scala.inline
  ...
  ): slinky.core.ReactComponentClass[T] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("memo")(Component.asInstanceOf[js.Any], propsAreEqual.asInstanceOf[js.Any])).asInstanceOf[slinky.core.ReactComponentClass[T]]
  @scala.inline
  def memo[P /* <: js.Object */](Component: slinky.core.ReactComponentClass[P]): slinky.core.ReactComponentClass[P] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("memo")(Component.asInstanceOf[js.Any])).asInstanceOf[slinky.core.ReactComponentClass[P]]
  @scala.inline
  ...
  ): slinky.core.ReactComponentClass[P] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("memo")(Component.asInstanceOf[js.Any], propsAreEqual.asInstanceOf[js.Any])).asInstanceOf[slinky.core.ReactComponentClass[P]]
  ...
  @scala.inline
  def useCallback[T /* <: js.Function1[/* repeated */ js.Any, _] */](callback: T, deps: typingsSlinky.react.mod.DependencyList): T = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("useCallback")(callback.asInstanceOf[js.Any], deps.asInstanceOf[js.Any])).asInstanceOf[T]
  ...
  /**
    ...
    */
  @scala.inline
  def useContext[T](context: typingsSlinky.react.mod.Context[T]): T = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("useContext")(context.asInstanceOf[js.Any])).asInstanceOf[T]
  /**
  ...
  /**
    ...
    */
  @scala.inline
  def useEffect(effect: typingsSlinky.react.mod.EffectCallback): scala.Unit = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("useEffect")(effect.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  @scala.inline
  def useEffect(effect: typingsSlinky.react.mod.EffectCallback, deps: typingsSlinky.react.mod.DependencyList): scala.Unit = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("useEffect")(effect.asInstanceOf[js.Any], deps.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  ...
  /**
    ...
    */
  @scala.inline
  def useImperativeHandle[T, R /* <: T */](ref: js.UndefOr[typingsSlinky.react.mod.Ref[T]], init: js.Function0[R]): scala.Unit = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("useImperativeHandle")(ref.asInstanceOf[js.Any], init.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  @scala.inline
  ...
  /**
    ...
    */
  @scala.inline
  def useLayoutEffect(effect: typingsSlinky.react.mod.EffectCallback): scala.Unit = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("useLayoutEffect")(effect.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  @scala.inline
  def useLayoutEffect(effect: typingsSlinky.react.mod.EffectCallback, deps: typingsSlinky.react.mod.DependencyList): scala.Unit = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("useLayoutEffect")(effect.asInstanceOf[js.Any], deps.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  /**
  ...
  @scala.inline
  def useMemo[T](factory: js.Function0[T], deps: typingsSlinky.react.mod.DependencyList): T = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("useMemo")(factory.asInstanceOf[js.Any], deps.asInstanceOf[js.Any])).asInstanceOf[T]
  /**
  ...
  @scala.inline
  def useRef[T](): typingsSlinky.react.mod.MutableRefObject[js.UndefOr[T]] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("useRef")()).asInstanceOf[typingsSlinky.react.mod.MutableRefObject[js.UndefOr[T]]]
  /**
    * `useRef` returns a mutable ref object whose `.current` property is initialized to the passed argument
    * (`initialValue`). The returned object will persist for the full lifetime of the component.
    *
  ...
  // TODO (TypeScript 3.0): <T extends unknown>
  @scala.inline
  def useRef[T](initialValue: T): typingsSlinky.react.mod.MutableRefObject[T] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("useRef")(initialValue.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.react.mod.MutableRefObject[T]]
  ...
  // TODO (TypeScript 3.0): <T extends unknown>
  @scala.inline
  def useRef_T_RefObject[T](): slinky.core.facade.ReactRef[T] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("useRef")()).asInstanceOf[slinky.core.facade.ReactRef[T]]
  @scala.inline
  def useRef_T_RefObject[T](initialValue: T): slinky.core.facade.ReactRef[T] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("useRef")(initialValue.asInstanceOf[js.Any])).asInstanceOf[slinky.core.facade.ReactRef[T]]
  ...
  /**
    ...
    */
  @scala.inline
  def useState[S](initialState: S): js.Tuple2[S, typingsSlinky.react.mod.Dispatch[typingsSlinky.react.mod.SetStateAction[S]]] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("useState")(initialState.asInstanceOf[js.Any])).asInstanceOf[js.Tuple2[S, typingsSlinky.react.mod.Dispatch[typingsSlinky.react.mod.SetStateAction[S]]]]
  @scala.inline
  def useState[S](initialState: js.Function0[S]): js.Tuple2[S, typingsSlinky.react.mod.Dispatch[typingsSlinky.react.mod.SetStateAction[S]]] = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("useState")(initialState.asInstanceOf[js.Any])).asInstanceOf[js.Tuple2[S, typingsSlinky.react.mod.Dispatch[typingsSlinky.react.mod.SetStateAction[S]]]]
  @scala.inline
