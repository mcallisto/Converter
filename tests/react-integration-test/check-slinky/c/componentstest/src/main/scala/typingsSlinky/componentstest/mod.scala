...
object mod {
  ...
  */
  ...
  @scala.inline
  def Card: CardInterface = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("Card")).asInstanceOf[CardInterface]
  @scala.inline
  def Component: ReactComponentClass[Props] = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("Component")).asInstanceOf[ReactComponentClass[Props]]
  @scala.inline
  def Grid: ReactComponentClass[CardGridProps] = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("Grid")).asInstanceOf[ReactComponentClass[CardGridProps]]
}
