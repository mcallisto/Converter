...
object mod {
  ...
  */
  ...
  @scala.inline
  def Component: ComponentType[Props] = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("Component")).asInstanceOf[ComponentType[Props]]
  @scala.inline
  def Grid: FC[CardGridProps] = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("Grid")).asInstanceOf[FC[CardGridProps]]
}
