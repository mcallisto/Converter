...
object mod {
  ...
  @scala.inline
  def ContextMenu: ComponentClassP[ContextMenuProps with js.Object] = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("ContextMenu")).asInstanceOf[ComponentClassP[ContextMenuProps with js.Object]]
  @scala.inline
  def ContextMenuTrigger: ComponentClassP[ContextMenuTriggerProps with js.Object] = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("ContextMenuTrigger")).asInstanceOf[ComponentClassP[ContextMenuTriggerProps with js.Object]]
  @scala.inline
  def MenuItem: ComponentClassP[MenuItemProps with js.Object] = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("MenuItem")).asInstanceOf[ComponentClassP[MenuItemProps with js.Object]]
  @scala.inline
  def SubMenu: ComponentClassP[SubMenuProps with js.Object] = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("SubMenu")).asInstanceOf[ComponentClassP[SubMenuProps with js.Object]]
  @scala.inline
