...
object accordionAccordionAccordionMod {
  ...
  @scala.inline
  def default: ComponentClassP[AccordionAccordionProps with js.Object] = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("default")).asInstanceOf[ComponentClassP[AccordionAccordionProps with js.Object]]
}
