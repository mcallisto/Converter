...
object accordionContentMod {
  ...
  @scala.inline
  def default: StatelessComponent[AccordionContentProps] = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("default")).asInstanceOf[StatelessComponent[AccordionContentProps]]
}
