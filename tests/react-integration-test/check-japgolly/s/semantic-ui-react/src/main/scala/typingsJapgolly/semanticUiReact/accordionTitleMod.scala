...
object accordionTitleMod {
  ...
  @scala.inline
  def default: ComponentClassP[AccordionTitleProps with js.Object] = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("default")).asInstanceOf[ComponentClassP[AccordionTitleProps with js.Object]]
}
