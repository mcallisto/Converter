...
object mod {
  ...
  @scala.inline
  def Ref: FunctionComponent[RefProps] = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("Ref")).asInstanceOf[FunctionComponent[RefProps]]
  /**
    ...
    */
  @scala.inline
  def handleRef[N](ref: Ref, node: N): Unit = ((^ .asInstanceOf[js.Dynamic]).applyDynamic("handleRef")(ref.asInstanceOf[js.Any], node.asInstanceOf[js.Any])).asInstanceOf[Unit]
