...
object RefForwardMod {
  ...
  implicit def make(companion: RefForwardMod.type): SharedBuilder_RefProps171925374[default] = new SharedBuilder_RefProps171925374[default](js.Array(this.component, js.Dictionary.empty))()
}
