...
object mod {
  ...
  @scala.inline
  def Chart: TypeofChart = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("Chart")).asInstanceOf[TypeofChart]
  @scala.inline
  def defaults: Dictkey = ((^ .asInstanceOf[js.Dynamic]).selectDynamic("defaults")).asInstanceOf[Dictkey]
  @scala.inline
